    ...
    <div className="w-full">
      <div className="mx-auto flex max-w-xs flex-col justify-center rounded-xl bg-white p-5 shadow-xl">
        ...
        <div className="mt-5 text-center">
          <p className="text-xl font-semibold text-gray-600 sm:text-2xl">
            {name}
          </p>
          <p className="inline-block w-auto border-b-2 px-5 pb-4 pt-2 text-xs text-gray-600 sm:text-base">
            {title}
          </p>
          <div className="align-center mt-4 flex justify-center">
            <a
              className="m-1 rounded-full p-1 text-xl text-gray-600 transition-colors duration-300 hover:bg-gray-800 hover:text-white sm:m-2 sm:p-2"
              href={github}
            >
              <FaGithub />
