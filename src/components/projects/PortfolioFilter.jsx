...
const PortfolioFilter = ({ setSelectFilterProject }) => {
  return (
    <select
      ...
      className="grow rounded-lg border-2 bg-dark-100 px-8 py-2 text-sm font-bold text-dark-900 focus:outline-none dark:border-violet-400 dark:bg-dark-600 dark:font-medium dark:text-gray-100"
    >
