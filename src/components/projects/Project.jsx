    ...
    >
      <div className="flex">
        <div className="group relative mx-auto mt-10 flex items-center justify-center">
          ...
          <div className="relative flex rounded-xl bg-dark-100 pb-5 dark:bg-dark-900">
            <Link to="/portfolio/project" aria-label="Indvidual Project">
              ...
              >
                <div className="text-center ">
                  <img
                    className="group h-auto w-full rounded-t-xl border-b-2 group-hover:border-b-violet-400/90"
                    src={image}
                    alt={title}
                  />
