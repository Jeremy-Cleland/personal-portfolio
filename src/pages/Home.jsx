...
const Home = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen mx-auto font-SourceCodePro">
      <div className="relative flex items-center justify-center w-full mx-auto group sm:w-3/4 lg:w-1/2 ">
