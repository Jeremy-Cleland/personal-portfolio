    ...
    <div className="mb-10">
      <div className="mx-auto my-2 max-w-7xl border-b-[1px] border-violet-400/60 py-5 text-center font-SourceCodePro text-dark-900 dark:text-gray-200 sm:mt-20 md:my-10">
        <h4 className="text-left font-Fira text-sm tracking-tight md:text-lg ">
          <span className="text-base text-violet-400"> {">"} </span> AI & Machine Learning Blog
        </h4>
      </div>
      ...
      >
        {/* Search Input */}
        <div className="group mx-5 flex w-full md:w-72 rounded-lg border-[1px] border-gray-200 bg-dark-100 pl-2 dark:border-violet-400/60 dark:bg-dark-600">
        ...
        <div>
          <select
            ...
            className="mx-5 w-full md:w-72 grow justify-end rounded-lg border-[1px] bg-dark-100 px-8 py-2 font-SourceCodePro text-sm text-dark-900 focus:outline-none dark:border-violet-400/60 dark:bg-dark-600 dark:text-gray-200"
          >
