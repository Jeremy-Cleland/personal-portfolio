...
// const Project = ({ id, title, category, image, onClick }) => {
//   const { updateSelectedProject } = useContext(SingleProjectContext);
...
//         className="mt-10 block"
//         onClick={() =>
//           onClick({ id, title, category, image, updateSelectedProject })
//         }
//       >
//         <div className="group relative mx-auto mt-10 flex items-center justify-center">
