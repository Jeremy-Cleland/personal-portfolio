...
const PortfolioSection = () => {
  ...
  return (
    <section className="my-10">
      <div className="mx-auto my-5 max-w-7xl border-b-[1px] border-violet-400/60 py-5 text-center font-SourceCodePro text-dark-900 dark:text-gray-200 sm:mt-20 md:my-10 xl:mt-36 2xl:mt-48">
      ...
      <div className="mx-auto my-2 grid max-w-7xl grid-rows-2 justify-between gap-5 sm:my-2.5 md:my-10 md:flex ">
