    ...
    >
      ...
      >
        <div className="group relative mx-auto mt-10 flex transform items-center justify-center transition duration-300 ease-in-out hover:scale-[1.02]">
          ...
          <div className="absolute -inset-0.5 animate-tilt rounded-lg bg-gradient-to-t from-orange-400/20 to-orange-400/70 opacity-40 blur transition duration-300 group-hover:opacity-70 dark:from-orange-400/20 dark:to-orange-400/70" />
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-4">
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                {tags.slice(0, 3).map((tag, index) => (
                  <span
                    key={index}
                    className="bg-orange-400/40 text-white text-xs px-2 py-1 rounded-full font-SourceCodePro"
                  >
                    {tag}
                  </span>
                ))}
              ...
              {/* Date */}
              {date && (
                <p className="text-dark-50 text-xs font-Fira mb-1">
                  {date}
                </p>
              )}
            </div>
